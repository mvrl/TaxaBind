...
cfg['data_path'] = "/scratch/k.subash/data/inat_image_sounds"
cfg["train_df"] = "/scratch/k.subash/data/inat_image_sounds/train_df.csv"
cfg["val_df"] = "/scratch/k.subash/data/inat_image_sounds/validate_df.csv"
cfg["test_df"] = "/scratch/k.subash/data/inat_image_sounds/test_df.csv"
cfg['log_path'] = "/home/k.subash/EcoBind/logs"