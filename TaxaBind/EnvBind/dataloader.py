...
class INatDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return img, env_feats, env_feats_neg, self.species_text.index(species_text)#self.filtered_json[idx]['label'], species_text, self.species_text.index(species_text)
